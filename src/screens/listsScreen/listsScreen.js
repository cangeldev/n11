...
import { AccountHeader, FocusAwareStatusBar } from 'components'
            ...
            <LinearGradient
                ...
                <View style={{ marginLeft: 15 }}>
                    <Text
                        ...
                        "Paylaş Kazan" ile listelerini istediğin  {"\n"} kişilerle paylaş, kupon kazanma fırsatını  {"\n"} yakala.
                    </Text>
                    <View style={style.linearView}>
                        <Text
                            style={style.linearViewText}>
                            Detayları Gör
                        </Text>
                        <IconO
                            style={style.linearViewIcon}
                            name="chevron-right"
                            color={colors.grey}
                            size={17}
                        />
